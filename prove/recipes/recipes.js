...
function search() {
    ...
    let filteredRecipes = recipes.filter(function(recipe){
        return ( 
            ...
            recipe.author.toLowerCase().includes(recipeQuery.toLowerCase()) ||
            recipe.recipeIngredient.find(ingredient => ingredient.toLowerCase().includes(recipeQuery.toLowerCase())) ||
...
function recipeTemplate(recipe) {
    return `
        <div class="recipe">
            <img src="${recipe.image}" alt="an image showing the food described in the recipe">
